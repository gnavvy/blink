...
public:
    ...
    void setupUi(QWidget *TaskImage1)
    {
        ...
        retranslateUi(TaskImage1);

        QMetaObject::connectSlotsByName(TaskImage1);
    } // setupUi
    ...
    void retranslateUi(QWidget *TaskImage1)
    {
        ...
        b7b->setText(QString());
        b11b->setText(QString());
        b4b->setText(QString());
        b8b->setText(QString());
        b6a->setText(QString());
        b8a->setText(QString());
        bgImg1->setText(QString());
        b7a->setText(QString());
        b5a->setText(QString());
        b12a->setText(QString());
        b6b->setText(QString());
        b10b->setText(QString());
        b3b->setText(QString());
        b1a->setText(QString());
        b3a->setText(QString());
...
namespace Ui {
    class TaskImage1: public Ui_TaskImage1 {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_TASKIMAGE1_H
